...
let yourSentence = "The \(nounArray[2]) is lit by the \(nounArray[8])"
let yourSillySentence = "The \(nounArray[index1]) ate a \(nounArray[index2])."
//: ### Exercise 2
...
let numChars = howManyCharacters.count
//: ### Exercise 4
...
let newStr = lottaLikes.replacingOccurrences(of: "like, ", with: "")
//: ### Exercise 7
// Example
